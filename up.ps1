...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.sc102project.localhost/ --auth https://id.sc102project.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.sc102project.localhost/ --auth https://id.sc102project.localhost/ --allow-write true
}
...
Start-Process https://cm.sc102project.localhost/sitecore/
Start-Process https://www.sc102project.localhost/
