...
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.sc102project.localhost"
}
Add-HostsEntry "cm.sc102project.localhost"
Add-HostsEntry "id.sc102project.localhost"
Add-HostsEntry "www.sc102project.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.sc102project.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.sc102project.localhost"
    }


    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.sc102project.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.sc102project.localhost"
